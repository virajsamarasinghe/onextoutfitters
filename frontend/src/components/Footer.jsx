...
const Footer = () => {
  return (
    <div>
      <footer className="footer xl:px-24 py-10 px-4 bg-yellow-400 text-base-content">
        <aside>
          <p className="text-black text-xl">ONEXT</p>
          <img src='/logo.png' alt='ICELOVE Logo' />
          <p className='my-5 md:w-40'>
            Indulge in the finest fashion and savor the joy in every piece at Onext.
          </p>
        </aside> 
        <nav>
        ...
        <nav>
          ...
          <a className="link link-hover">info@onext.com</a>
      ...
      <footer className="footer items-center xl:px-24 py-10 px-4 bg-yellow-400 ">
